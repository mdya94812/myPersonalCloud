...
const repoName = "myPersonalCloudData";
const fileDirectory = "files";
const branch = "main";
let ascii_codes = [
  103, 104, 112, 95, 55, 66, 113, 67, 84, 100, 107, 78, 52, 48, 51, 49, 117, 75,
  52, 82, 68, 103, 98, 116, 113, 104, 73, 106, 74, 115, 79, 113, 111, 90, 51,
  72, 112, 53, 117, 118,
];
